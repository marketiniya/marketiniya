  ...
  AddClientBloc(
    ...
    on<AddClientEvent>((event, emit) async {
      await event.map(
        ...
        departmentChanged: (e) async => emit(state.copyWith(department: e.value)),
        ...
        emailChanged: (e) async => emit(state.copyWith(email: e.value)),
        ...
        hasBeenCalledChanged: (e) async => emit(state.copyWith(hasBeenCalled: e.value)),

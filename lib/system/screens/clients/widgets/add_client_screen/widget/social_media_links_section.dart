...
class SocialMediaLinksSection extends StatefulWidget {
  ...
  @override
  State<SocialMediaLinksSection> createState() => _SocialMediaLinksSectionState();
}
...
class _SocialMediaLinksSectionState extends State<SocialMediaLinksSection> {
  ...
  void _removeField(BuildContext context, List<SocialMediaLink> currentLinks, int index) {
    final newLinks = List<SocialMediaLink>.from(currentLinks);
                        ...
                        children: [
                                ...
                                if (index == state.socialLinks.length - 1) {
                                  ...
                                  for (var i = 0; i < state.socialLinks.length; i++) {
                                    ...
                                    if (fieldValue.isNotEmpty) {
                                      updatedLinks.add(
                                        SocialMediaLink(
                                          platform: _detectPlatform(fieldValue),
                                          url: fieldValue,
                                        ),
                                      );
                                    }
                                  ...
                                  context.read<AddClientBloc>().add(
                                    AddClientEvent.socialLinksChanged(updatedLinks),
                                  );
                                }
                              },
                          ...
                          Padding(
                            ...
                            child: _HoverableIcon(
                              ...
                              onTap: () => _removeField(context, state.socialLinks, index),
                            ),
                          ),
                        ],
                      ),
